...
<body>
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="Blogtechs.php">Tech</a>
    <a class="dropdown-item" href="Blogindians.php">Indian</a>
    <a class="dropdown-item" href="Bloginternationals.php">International</a>
  </div>
</div> 
...
<div class="dropdown">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="Newstechs.php">Tech</a>
    <a class="dropdown-item" href="Newsindians.php">Indian</a>
    <a class="dropdown-item" href="Newsinternationals.php">International</a>
  </div>
</div> 
...
<!-- <input type="text" name="category" placeholder="Blog/News"> -->
...
if($result->num_rows > 0){
    while($row = $result->fetch_assoc()){
        echo "<b>"."Title:" .$row["title"]."</b>"."<br>".$row["post"]."<br>"."<i>Posted By--</i><br>"."<b>".$row["name"]."</b>"." "."<b>".$row["time"]."</b>"." "."<b>"."<br>".$row["Category"]."</b>";
