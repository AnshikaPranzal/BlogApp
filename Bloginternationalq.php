...
<body>
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="Blogtechq.php">Tech</a>
    <a class="dropdown-item" href="Blogindianq.php">Indian</a>
    <a class="dropdown-item" href="Bloginternationalq.php">International</a>
  </div>
</div> 
...
<div class="dropdown">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="Newstechq.php">Tech</a>
    <a class="dropdown-item" href="Newsindianq.php">Indian</a>
    <a class="dropdown-item" href="Newsinternationalq.php">International</a>
  </div>
</div> 
...
<?php $sql="SELECT * FROM posts2 WHERE Category='Blog-International'";
$result = $conn->query($sql);
