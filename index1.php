...
<?php $sql="SELECT * FROM posts ORDER BY id desc LIMIT 5";
...
<?php $sql="SELECT * FROM posts1 ORDER BY id desc LIMIT 4";
$result = $conn->query($sql);
...
<?php $sql="SELECT * FROM posts2 ORDER BY id desc LIMIT 5";
$result = $conn->query($sql);
